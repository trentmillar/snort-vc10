; $Id$
;
; NSIS Installation script for Snort 2.9.4.6 Win32
; Written by Chris Reid <chris.reid@codecraftconsultants.com>
; Updated by Steven Sturges <ssturges@sourcefire.com>
;
; This script will create a Win32 installer for Snort 2.9.4.6 (Win32 only).
...
;Configuration
  ...
  ;General
  OutFile "Snort_2_9_4_6_Installer.exe"  ; The name of the installer executable
